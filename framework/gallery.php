...
add_action( 'init', 'vw_setup_custom_post_gallery' );
function vw_setup_custom_post_gallery() {
	$enable_custom_gallery = vw_get_option( 'blog_enable_custom_gallery', '1' );

	if ( $enable_custom_gallery == '1' ) {
		add_filter( 'post_gallery', 'vw_custom_post_gallery', 10, 2 );
 ...
 * -------------------------------------------------------------------------- */
if ( ! function_exists( 'vw_custom_gallery' ) ) {
