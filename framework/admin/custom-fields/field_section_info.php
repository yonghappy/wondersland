...
class Redux_Options_section_info {
    ...
    */
    function render() {
        ...
        echo '</td></tr></table><div class="redux-opts-section-info-field' . $class . '">' . $this->field['desc'] . '</div><table class="form-table no-border"><tbody><tr style="display: none;"><th></th><td>';
    }
}
